...
<div class="alert alert-success text-center" role="alert">
  ...
  <div class="container mt-5">
    ...
    <p class="lead alert alert-info fw-bold text-center cart-count mx-auto mb-5">
      You have <span class="text-primary"><?= count($items) ?> item<?= count($items) == 1 ? '' : 's' ?></span> in your cart
    </p>
        ...
        <div class="col">
          <div class="card h-100 shadow-sm">
            ...
            <div class="card-body">
              ...
              <p class="card-text mb-1">Price: <span class="text-success fw-bold">R<?= number_format($row['item_price'], 2) ?></span></p>
              ...
              <div class="d-flex gap-2 mt-auto">
                ...
                <form method="post" action="update_cart.php" class="d-flex flex-grow-1">
                  ...
                  <input type="number" name="quantity" value="<?= $row['quantity'] ?>" class="form-control form-control-sm me-1" min="1">
